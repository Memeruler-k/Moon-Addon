...
public class KillauraPlus extends Module {
    public KillauraPlus() {
        super(Addon.CATEGORY, "Kill Aura+", "Better Killaura.");
    }
    
    public final SettingGroup sgGeneral = settings.getDefaultGroup();
    public final SettingGroup sgTargeting = settings.createGroup("Bypass");
    public final SettingGroup sgDelay = settings.createGroup("Delay");
    public final SettingGroup sgBypass = settings.createGroup("Targeting");

    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Grim)
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Vulcan)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Spartan)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.NoCheatPlus)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Hypixel)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Cubecraft)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Watchdog)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Verus)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Polar)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Intave)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Mineplex)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Negativity)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.NegativityV2)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Themis)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Wave)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Storm)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.PikaNetwork)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.PVPLand)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.PVPLegacy)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Custom)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.OverFlow)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.Wraith)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
    ...
    private final Setting<KillAuraPlusModes> mode = sgBypass.add(new EnumSetting.Builder<KillAuraPlusModes>()
		.name("mode")
		.description("KillAura mode.")
		.defaultValue(KillAuraPlusModes.GodsEye)
		.onModuleActivated(modesSetting -> onModeChanged(modesSetting.get()))
		.onChanged(this::onModeChanged)
		.build()
	);
