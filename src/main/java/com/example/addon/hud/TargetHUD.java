...
public class TargetHUD extends HudElement 
   ...
   public class TargetHud extends HudElement {
    ...
    public static final HudElementInfo<TargetHUD> INFO = new HudElementInfo<>(Addon.HUD_GROUP, "Target HUD", "Displays target's info when entering combat.", TargetHUD::new);
